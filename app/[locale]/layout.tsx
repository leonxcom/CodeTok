        ...
        <footer className="w-full bg-default-900/20 border-t border-default-200/50 py-12 mt-20">
          <div className="container mx-auto max-w-7xl px-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {/* 公司信息 */}
              <div>
                <h3 className="text-lg font-bold mb-4">{messages.app.footer.company}</h3>
              ...
              {/* 资源 */}
              <div>
                <h3 className="text-lg font-bold mb-4">{messages.app.footer.resources}</h3>
                <ul className="space-y-2">
                  <li>
                    <Link 
                      href={`/${locale}/docs`}
              ...
              {/* 法律 */}
              <div>
                <h3 className="text-lg font-bold mb-4">{messages.app.footer.legal}</h3>
                <ul className="space-y-2">
                  <li>
                    <Link 
                      href={`/${locale}/terms`}
              ...
              {/* 联系我们 */}
              <div>
                <h3 className="text-lg font-bold mb-4">{messages.app.footer.contact}</h3>
            ...
            <div className="border-t border-default-200/50 mt-10 pt-6 text-center text-default-500">
              <p>{messages.app.footer.rights}</p>
            </div>
          </div>
        </footer>
      </div>
